...
export function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      {/* Terms */}
      <p className="text-center text-[12px] text-[#A09D99] leading-relaxed">
        By creating an account you agree to our{" "}
        <a href="#" className="text-[#6B6760] underline underline-offset-4 hover:text-[#0D1F3C] transition-colors">
          Terms of Service
        </a>{" "}
        and{" "}
        <a href="#" className="text-[#6B6760] underline underline-offset-4 hover:text-[#0D1F3C] transition-colors">
